...
const { Nrr, Tree, FILLER_ITERS, USE_WITNESS_FIELDS } = await import("./programs.js");
...
console.log(`FILLER_ITERS = ${FILLER_ITERS}  witness-mode = ${USE_WITNESS_FIELDS ? "witnessFields" : "witness"}`);
