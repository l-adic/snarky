...
/-! # The kimchi `EndoMulScalar` (endo scalar decomposition) gate (checker model).
...
the soundness proof of endo-scalar decomposition lives separately at
`Kimchi.Gate.EndoScalar`. -/

namespace Kimchi.Checker.EndoScalar
