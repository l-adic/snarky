...
def roots : List Name :=
  [ `Kimchi.Gate.Generic.sound, `Kimchi.Gate.Generic.complete,
    ...
    `Kimchi.GrandProduct.prod_eq_of_accumulator,
    `Kimchi.Permutation.soundness,
    `Kimchi.GrandProduct.copy_soundness, `Kimchi.Permutation.copy_soundness,
    `Kimchi.Permutation.copy_soundness_wired,
    `Kimchi.Index.satisfies_iff_fullFamily_dvd,
    `Kimchi.GrandProduct.multiset_eq_of_prod_eval,
