...
def moduleSrc (defName field : String) (toks : Array PolishToken) : String :=
  ...
  s!"import Pickles.Linearization.Types\n\
     ...
     \n\
     Generated by `formal/pickles/scripts/gen_tokens.lean` from the Rust dump; do not edit.\n\
     The PureScript token modules come from the same JSON, so the two are independent\n\
     transcriptions of one origin.\n\
     -/\n\
     \n\
