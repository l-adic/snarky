...
def roots : List Name :=
  [ `Kimchi.Gate.Generic.sound, `Kimchi.Gate.Generic.complete,
    ...
    `Kimchi.Index.Index.addComplete_soundness,
    `Kimchi.Index.Index.varBaseMul_soundness,
    `Kimchi.Index.Index.endoMul_soundness,
    `Kimchi.Index.Index.endoScalar_soundness,
    `Kimchi.Index.Index.poseidon_soundness,
    `Kimchi.Index.Index.generic_soundness,
    `Kimchi.Index.Index.copy_soundness,
