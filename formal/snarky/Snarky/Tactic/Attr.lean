...
monotonicity vocabulary up by attribute, so a downstream gadget file extends both by
...
/-- A monotonicity lemma: how one shape of context conjunct survives the
