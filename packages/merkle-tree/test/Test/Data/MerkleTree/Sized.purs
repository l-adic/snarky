...
import Data.MerkleTree.Sized (class Hashable)
...
canRecoverElementsAddMany :: forall n f. Reflectable n Int => Hashable f f => PoseidonField f => Proxy n -> NonEmptyArray f -> Result
canRecoverElementsAddMany _ xs =
  let
    { head: a, tail: as } = NEA.uncons xs

    base :: SMT.MerkleTree n (Digest f) f
    base = SMT.create a
...
canRecoverElementsAdd :: forall n f. Reflectable n Int => PoseidonField f => Hashable f f => Proxy n -> NonEmptyArray f -> Result
...
pathValidationLaw :: forall n f. Reflectable n Int => Hashable f f => PoseidonField f => Proxy n -> NonEmptyArray f -> Result
...
setGetLaw :: forall n f. Reflectable n Int => Hashable f f => PoseidonField f => Proxy n -> NonEmptyArray f -> Int -> f -> Result
...
setPreservesOthersLaw :: forall n f. Reflectable n Int => PoseidonField f => Hashable f f => Proxy n -> NonEmptyArray f -> Int -> f -> Result
...
setUpdatesRootLaw :: forall n f. Reflectable n Int => Hashable f f => PoseidonField f => Proxy n -> NonEmptyArray f -> Int -> f -> Result
...
setInvalidAddressLaw :: forall n f. Reflectable n Int => Hashable f f => PoseidonField f => Proxy n -> NonEmptyArray f -> Int -> f -> Result
