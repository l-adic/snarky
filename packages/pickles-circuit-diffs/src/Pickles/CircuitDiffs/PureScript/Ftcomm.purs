...
parseFtcommInput :: Vector 17 (FVar Field) -> FtcommInput Field
...
compileFtcomm :: CompiledCircuit Field
compileFtcomm =
  compilePure (Proxy @(Vector 17 (F Field))) (Proxy @Unit) (Proxy @(KimchiConstraint Field))
