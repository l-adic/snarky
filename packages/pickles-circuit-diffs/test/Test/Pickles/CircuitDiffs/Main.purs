...
import Pickles.CircuitDiffs.PureScript.PseudoCircuits (compileChooseKeyN1Wrap, compileOneHotN1Step, compileOneHotN1Wrap, compileOneHotN3Step, compileOneHotN3Wrap, compilePseudoMaskN1Step, compilePseudoMaskN1Wrap, compilePseudoMaskN3Step, compilePseudoMaskN3Wrap, compilePseudoChooseN1Step, compilePseudoChooseN1Wrap, compilePseudoChooseN3Step, compilePseudoChooseN3Wrap)
...
import Pickles.CircuitDiffs.PureScript.WrapMain (compileWrapMain)
  ...
  beforeAll_ (liftEffect resetOutputDirs) $
    describe "Circuit comparison" do
      ...
      describe "IVP" do
        ...
        exactMatch "wrap_main_circuit" (fromCompiledCircuit $ compileWrapMain wrapSrsData)
        let
