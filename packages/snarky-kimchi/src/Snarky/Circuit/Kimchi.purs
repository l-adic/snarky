...
import Snarky.Types.Shifted (class Shifted, Type1(..), Type2(..), fieldSizeBits, forbiddenShiftedValues, forbiddenType1Values, forbiddenType2Values, fromShifted, fromShiftedType1Circuit, fromShiftedType2Circuit, ofFieldType1Circuit, shiftedEqualType1, shiftedEqualType2, toShifted)
