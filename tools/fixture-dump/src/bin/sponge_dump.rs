//! Kimchi Poseidon sponge data for the Lean formalization (`formal/poseidon`).
//!
//! Emits two artifacts from `mina_poseidon`:
//!
//! * `ConstantsFq.lean` / `ConstantsFp.lean` — the `fq_kimchi` / `fp_kimchi`
...
//!   `formal/poseidon/Poseidon/`; regenerate here on a proof-systems bump.
...
fn emit_poseidon<F: ark_ff::PrimeField>(
    ...
    writeln!(
        ...
        "/-!\n\
         ...
         \n\
         The kimchi sponge parameters from proof-systems' Poseidon crate (width 3, rate 2,\n\
         55 full rounds, `x^7` S-box, full MDS, no initial ARK), as canonical `Nat` values.\n\
         \n\
         Generated by the fixture-dump tool; do not edit by hand.\n\
         -/\n\
         \n\
         namespace Poseidon.{ns}\n"
    )
    .unwrap();
...
fn main() {
    ...
    emit_poseidon::<Fq>(
        ...
        "Vesta base field",
        "FqKimchi",
        &format!("{lean_dir}/ConstantsFq.lean"),
        "fq_kimchi",
    ...
    emit_poseidon::<mina_curves::pasta::Fp>(
        ...
        "Pallas base field",
        "FpKimchi",
        &format!("{lean_dir}/ConstantsFp.lean"),
        "fp_kimchi",
